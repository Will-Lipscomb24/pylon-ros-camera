...
class ImageSaverNode(Node):
    def __init__(self):
        ...
        self.saved_count  = 1
        self.folder_count = 0
        self._create_folder_ifnotexists()
    ...
    def image_callback(self, msg: Image):
        ...
        filename = f'images_{self.folder_count}/{self.image_prefix}_{self.saved_count}_{file_ns}.png'
    ...
    def _create_folder_ifnotexists( self ):
        os.makedirs(os.path.join(self.save_dir, f"images_{self.folder_count}/"), exist_ok=True)
